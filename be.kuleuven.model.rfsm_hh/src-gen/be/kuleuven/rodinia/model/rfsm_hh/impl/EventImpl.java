 ...
 * <ul>
 *   <li>{@link be.kuleuven.rodinia.model.rfsm_hh.impl.EventImpl#getEventliteral <em>Eventliteral</em>}</li>
 *   <li>{@link be.kuleuven.rodinia.model.rfsm_hh.impl.EventImpl#getOwner <em>Owner</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventImpl extends MinimalEObjectImpl.Container implements Event
{
  ...
  {
    return Rfsm_hhPackage.Literals.EVENT;
  }
  ...
  public void setEventliteral(String newEventliteral)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Rfsm_hhPackage.EVENT__EVENTLITERAL, oldEventliteral, eventliteral));
  }
  ...
  {
    if (eContainerFeatureID() != Rfsm_hhPackage.EVENT__OWNER) return null;
  ...
  {
    msgs = eBasicSetContainer((InternalEObject)newOwner, Rfsm_hhPackage.EVENT__OWNER, msgs);
    return msgs;
  }
  ...
  {
    if (newOwner != eInternalContainer() || (eContainerFeatureID() != Rfsm_hhPackage.EVENT__OWNER && newOwner != null))
    {
      ...
      if (newOwner != null)
        msgs = ((InternalEObject)newOwner).eInverseAdd(this, Rfsm_hhPackage.TRANSITION__EVENTS, Transition.class, msgs);
      msgs = basicSetOwner(newOwner, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Rfsm_hhPackage.EVENT__OWNER, newOwner, newOwner));
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Rfsm_hhPackage.EVENT__OWNER:
        if (eInternalContainer() != null)
          msgs = eBasicRemoveFromContainer(msgs);
  ...
  public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
  {
    ...
    {
      case Rfsm_hhPackage.EVENT__OWNER:
        return eInternalContainer().eInverseRemove(this, Rfsm_hhPackage.TRANSITION__EVENTS, Transition.class, msgs);
    }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Rfsm_hhPackage.EVENT__EVENTLITERAL:
