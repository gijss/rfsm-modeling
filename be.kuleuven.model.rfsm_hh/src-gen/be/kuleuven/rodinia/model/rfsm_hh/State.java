 ...
 * <ul>
 *   <li>{@link be.kuleuven.rodinia.model.rfsm_hh.State#getEntry <em>Entry</em>}</li>
 *   <li>{@link be.kuleuven.rodinia.model.rfsm_hh.State#getDoo <em>Doo</em>}</li>
 *   <li>{@link be.kuleuven.rodinia.model.rfsm_hh.State#getExit <em>Exit</em>}</li>
 * </ul>
 * </p>
 *
 * @see be.kuleuven.rodinia.model.rfsm_hh.Rfsm_hhPackage#getState()
 ...
 * @generated
 */
public interface State extends HyperVertex
{
  /**
   ...
   * @see be.kuleuven.rodinia.model.rfsm_hh.Rfsm_hhPackage#getState_Entry()
  ...
  /**
   * Sets the value of the '{@link be.kuleuven.rodinia.model.rfsm_hh.State#getEntry <em>Entry</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setDoo(Function)
   * @see be.kuleuven.rodinia.model.rfsm_hh.Rfsm_hhPackage#getState_Doo()
   * @model containment="true"
   * @generated
   */
  Function getDoo();
  ...
  /**
   * Sets the value of the '{@link be.kuleuven.rodinia.model.rfsm_hh.State#getDoo <em>Doo</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see be.kuleuven.rodinia.model.rfsm_hh.Rfsm_hhPackage#getState_Exit()
   * @model containment="true"
   * @generated
   */
  Function getExit();
  ...
  /**
   * Sets the value of the '{@link be.kuleuven.rodinia.model.rfsm_hh.State#getExit <em>Exit</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
