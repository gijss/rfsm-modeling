 ...
 * <ul>
 *   <li>{@link be.kuleuven.rodinia.model.rfsm.impl.HyperEdgeImpl#getName <em>Name</em>}</li>
 *   <li>{@link be.kuleuven.rodinia.model.rfsm.impl.HyperEdgeImpl#getSource <em>Source</em>}</li>
 *   <li>{@link be.kuleuven.rodinia.model.rfsm.impl.HyperEdgeImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HyperEdgeImpl extends MinimalEObjectImpl.Container implements HyperEdge
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RfsmPackage.HYPER_EDGE__NAME, oldName, name));
  }
  ...
  public EList<HyperVertex> getSource()
  {
    if (source == null)
    {
      source = new EObjectResolvingEList<HyperVertex>(HyperVertex.class, this, RfsmPackage.HYPER_EDGE__SOURCE);
    }
    return source;
  }
  ...
  public EList<HyperVertex> getTarget()
  {
    if (target == null)
    {
      target = new EObjectResolvingEList<HyperVertex>(HyperVertex.class, this, RfsmPackage.HYPER_EDGE__TARGET);
    }
    return target;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RfsmPackage.HYPER_EDGE__NAME:
        return getName();
      case RfsmPackage.HYPER_EDGE__SOURCE:
        return getSource();
      case RfsmPackage.HYPER_EDGE__TARGET:
        return getTarget();
    }
