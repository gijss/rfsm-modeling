 ...
 * <ul>
 *   <li>{@link be.kuleuven.rodinia.model.rfsm.impl.HyperGraphImpl#getName <em>Name</em>}</li>
 *   <li>{@link be.kuleuven.rodinia.model.rfsm.impl.HyperGraphImpl#getHyperVertices <em>Hyper Vertices</em>}</li>
 *   <li>{@link be.kuleuven.rodinia.model.rfsm.impl.HyperGraphImpl#getHyperEdges <em>Hyper Edges</em>}</li>
 *   <li>{@link be.kuleuven.rodinia.model.rfsm.impl.HyperGraphImpl#getHyperGraphs <em>Hyper Graphs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HyperGraphImpl extends MinimalEObjectImpl.Container implements HyperGraph
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RfsmPackage.HYPER_GRAPH__NAME, oldName, name));
  }
  ...
  public EList<HyperEdge> getHyperEdges()
  {
    if (hyperEdges == null)
    {
      hyperEdges = new EObjectContainmentEList<HyperEdge>(HyperEdge.class, this, RfsmPackage.HYPER_GRAPH__HYPER_EDGES);
    }
    return hyperEdges;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case RfsmPackage.HYPER_GRAPH__HYPER_EDGES:
        return ((InternalEList<?>)getHyperEdges()).basicRemove(otherEnd, msgs);
      case RfsmPackage.HYPER_GRAPH__HYPER_GRAPHS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RfsmPackage.HYPER_GRAPH__NAME:
        return getName();
      case RfsmPackage.HYPER_GRAPH__HYPER_VERTICES:
