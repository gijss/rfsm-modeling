 ...
 * <ul>
 *   <li>{@link be.kuleuven.rodinia.dsl.lua.impl.Expression_CallMemberFunctionImpl#getObject <em>Object</em>}</li>
 *   <li>{@link be.kuleuven.rodinia.dsl.lua.impl.Expression_CallMemberFunctionImpl#getMemberFunctionName <em>Member Function Name</em>}</li>
 *   <li>{@link be.kuleuven.rodinia.dsl.lua.impl.Expression_CallMemberFunctionImpl#getArguments <em>Arguments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Expression_CallMemberFunctionImpl extends ExpressionImpl implements Expression_CallMemberFunction
{
  ...
  {
    return LuaPackage.Literals.EXPRESSION_CALL_MEMBER_FUNCTION;
  }
  ...
  public NotificationChain basicSetObject(Expression newObject, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LuaPackage.EXPRESSION_CALL_MEMBER_FUNCTION__OBJECT, oldObject, newObject);
  ...
  public void setObject(Expression newObject)
  {
    if (newObject != object)
    {
      ...
      if (object != null)
        msgs = ((InternalEObject)object).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LuaPackage.EXPRESSION_CALL_MEMBER_FUNCTION__OBJECT, null, msgs);
      if (newObject != null)
        msgs = ((InternalEObject)newObject).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LuaPackage.EXPRESSION_CALL_MEMBER_FUNCTION__OBJECT, null, msgs);
      msgs = basicSetObject(newObject, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LuaPackage.EXPRESSION_CALL_MEMBER_FUNCTION__OBJECT, newObject, newObject));
  }
  ...
  public void setMemberFunctionName(String newMemberFunctionName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LuaPackage.EXPRESSION_CALL_MEMBER_FUNCTION__MEMBER_FUNCTION_NAME, oldMemberFunctionName, memberFunctionName));
  }
  ...
  public NotificationChain basicSetArguments(Functioncall_Arguments newArguments, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LuaPackage.EXPRESSION_CALL_MEMBER_FUNCTION__ARGUMENTS, oldArguments, newArguments);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setArguments(Functioncall_Arguments newArguments)
  {
    if (newArguments != arguments)
    {
      NotificationChain msgs = null;
      if (arguments != null)
        msgs = ((InternalEObject)arguments).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LuaPackage.EXPRESSION_CALL_MEMBER_FUNCTION__ARGUMENTS, null, msgs);
      if (newArguments != null)
        msgs = ((InternalEObject)newArguments).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LuaPackage.EXPRESSION_CALL_MEMBER_FUNCTION__ARGUMENTS, null, msgs);
      msgs = basicSetArguments(newArguments, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LuaPackage.EXPRESSION_CALL_MEMBER_FUNCTION__ARGUMENTS, newArguments, newArguments));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case LuaPackage.EXPRESSION_CALL_MEMBER_FUNCTION__OBJECT:
        return basicSetObject(null, msgs);
      case LuaPackage.EXPRESSION_CALL_MEMBER_FUNCTION__ARGUMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LuaPackage.EXPRESSION_CALL_MEMBER_FUNCTION__OBJECT:
        return getObject();
      case LuaPackage.EXPRESSION_CALL_MEMBER_FUNCTION__MEMBER_FUNCTION_NAME:
