 ...
 * <ul>
 *   <li>{@link be.kuleuven.rodinia.dsl.lua.impl.Expression_VariableNameImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Expression_VariableNameImpl extends ExpressionImpl implements Expression_VariableName
{
  ...
  {
    return LuaPackage.Literals.EXPRESSION_VARIABLE_NAME;
  }
  ...
  public void setVariable(String newVariable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LuaPackage.EXPRESSION_VARIABLE_NAME__VARIABLE, oldVariable, variable));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LuaPackage.EXPRESSION_VARIABLE_NAME__VARIABLE:
        return getVariable();
    }
