 ...
 * <ul>
 *   <li>{@link be.kuleuven.rodinia.dsl.lua.Statement_If_Then_Else_ElseIfPart#getElseifExpression <em>Elseif Expression</em>}</li>
 *   <li>{@link be.kuleuven.rodinia.dsl.lua.Statement_If_Then_Else_ElseIfPart#getElseifBlock <em>Elseif Block</em>}</li>
 * </ul>
 * </p>
 *
 * @see be.kuleuven.rodinia.dsl.lua.LuaPackage#getStatement_If_Then_Else_ElseIfPart()
 * @model
 * @generated
 */
public interface Statement_If_Then_Else_ElseIfPart extends EObject
{
   ...
   * @see be.kuleuven.rodinia.dsl.lua.LuaPackage#getStatement_If_Then_Else_ElseIfPart_ElseifExpression()
  ...
  /**
   * Sets the value of the '{@link be.kuleuven.rodinia.dsl.lua.Statement_If_Then_Else_ElseIfPart#getElseifExpression <em>Elseif Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see be.kuleuven.rodinia.dsl.lua.LuaPackage#getStatement_If_Then_Else_ElseIfPart_ElseifBlock()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link be.kuleuven.rodinia.dsl.lua.Statement_If_Then_Else_ElseIfPart#getElseifBlock <em>Elseif Block</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
