...
public class LuaGrammarAccess extends AbstractGrammarElementFinder {
	...
	private ChunkElements pChunk;
	private BlockElements pBlock;
	private LastStatementElements pLastStatement;
	private LastStatement_ReturnElements pLastStatement_Return;
	private LastStatement_BreakElements pLastStatement_Break;
	private StatementElements pStatement;
	private Statement_BlockElements pStatement_Block;
	private Statement_WhileElements pStatement_While;
	private Statement_RepeatElements pStatement_Repeat;
	private Statement_If_Then_ElseElements pStatement_If_Then_Else;
	private Statement_If_Then_Else_ElseIfPartElements pStatement_If_Then_Else_ElseIfPart;
	private Statement_For_NumericElements pStatement_For_Numeric;
	private Statement_For_GenericElements pStatement_For_Generic;
	private Statement_GlobalFunction_DeclarationElements pStatement_GlobalFunction_Declaration;
	private Statement_LocalFunction_DeclarationElements pStatement_LocalFunction_Declaration;
	private Statement_Local_Variable_DeclarationElements pStatement_Local_Variable_Declaration;
	private Statement_FunctioncallOrAssignmentElements pStatement_FunctioncallOrAssignment;
	private ExpressionElements pExpression;
	private Expression_OrElements pExpression_Or;
	private Expression_AndElements pExpression_And;
	private Expression_CompareElements pExpression_Compare;
	private Expression_ConcatenationElements pExpression_Concatenation;
	private Expression_PlusMinusElements pExpression_PlusMinus;
	private Expression_MultiplicationDivisionModuloElements pExpression_MultiplicationDivisionModulo;
	private Expression_UnaryElements pExpression_Unary;
	private Expression_ExponentiationElements pExpression_Exponentiation;
	private Expression_TerminalElements pExpression_Terminal;
	private Expression_NilElements pExpression_Nil;
	private Expression_TrueElements pExpression_True;
	private Expression_FalseElements pExpression_False;
	private Expression_NumberElements pExpression_Number;
	private Expression_VarArgsElements pExpression_VarArgs;
	private Expression_StringElements pExpression_String;
	private Expression_FunctionElements pExpression_Function;
	private Expression_TableConstructorElements pExpression_TableConstructor;
	private Expression_FunctioncallElements pExpression_Functioncall;
	private Expression_AccessMemberOrArrayElementElements pExpression_AccessMemberOrArrayElement;
	private Expression_VariableNameElements pExpression_VariableName;
	private FunctionElements pFunction;
	private Functioncall_ArgumentsElements pFunctioncall_Arguments;
	private FieldElements pField;
	private Field_AddEntryToTable_BracketsElements pField_AddEntryToTable_Brackets;
	private Field_AddEntryToTableElements pField_AddEntryToTable;
	private Field_AppendEntryToTableElements pField_AppendEntryToTable;
	private TerminalRule tCOMMENT;
	private TerminalRule tWS;
	private TerminalRule tLUA_NAME;
	private TerminalRule tLUA_STRING;
	private TerminalRule tLUA_NUMBER;
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("be.kuleuven.rodinia.dsl.Lua".equals(grammar.getName())) {
				return grammar;
			}
	...
	public ChunkElements getChunkAccess() {
		return (pChunk != null) ? pChunk : (pChunk = new ChunkElements());
	}
	...
	public LastStatementElements getLastStatementAccess() {
		return (pLastStatement != null) ? pLastStatement : (pLastStatement = new LastStatementElements());
	}
	...
	public LastStatement_ReturnElements getLastStatement_ReturnAccess() {
		return (pLastStatement_Return != null) ? pLastStatement_Return : (pLastStatement_Return = new LastStatement_ReturnElements());
	}
	...
	public LastStatement_BreakElements getLastStatement_BreakAccess() {
		return (pLastStatement_Break != null) ? pLastStatement_Break : (pLastStatement_Break = new LastStatement_BreakElements());
	}
	...
	public Statement_BlockElements getStatement_BlockAccess() {
		return (pStatement_Block != null) ? pStatement_Block : (pStatement_Block = new Statement_BlockElements());
	}
	...
	public Statement_WhileElements getStatement_WhileAccess() {
		return (pStatement_While != null) ? pStatement_While : (pStatement_While = new Statement_WhileElements());
	}
	...
	public Statement_RepeatElements getStatement_RepeatAccess() {
		return (pStatement_Repeat != null) ? pStatement_Repeat : (pStatement_Repeat = new Statement_RepeatElements());
	}
	...
	public Statement_If_Then_ElseElements getStatement_If_Then_ElseAccess() {
		return (pStatement_If_Then_Else != null) ? pStatement_If_Then_Else : (pStatement_If_Then_Else = new Statement_If_Then_ElseElements());
	}
	...
	public Statement_If_Then_Else_ElseIfPartElements getStatement_If_Then_Else_ElseIfPartAccess() {
		return (pStatement_If_Then_Else_ElseIfPart != null) ? pStatement_If_Then_Else_ElseIfPart : (pStatement_If_Then_Else_ElseIfPart = new Statement_If_Then_Else_ElseIfPartElements());
	}
	...
	public Statement_For_NumericElements getStatement_For_NumericAccess() {
		return (pStatement_For_Numeric != null) ? pStatement_For_Numeric : (pStatement_For_Numeric = new Statement_For_NumericElements());
	}
	...
	public Statement_For_GenericElements getStatement_For_GenericAccess() {
		return (pStatement_For_Generic != null) ? pStatement_For_Generic : (pStatement_For_Generic = new Statement_For_GenericElements());
	}
	...
	public Statement_GlobalFunction_DeclarationElements getStatement_GlobalFunction_DeclarationAccess() {
		return (pStatement_GlobalFunction_Declaration != null) ? pStatement_GlobalFunction_Declaration : (pStatement_GlobalFunction_Declaration = new Statement_GlobalFunction_DeclarationElements());
	}
	...
	public Statement_LocalFunction_DeclarationElements getStatement_LocalFunction_DeclarationAccess() {
		return (pStatement_LocalFunction_Declaration != null) ? pStatement_LocalFunction_Declaration : (pStatement_LocalFunction_Declaration = new Statement_LocalFunction_DeclarationElements());
	}
	...
	public Statement_Local_Variable_DeclarationElements getStatement_Local_Variable_DeclarationAccess() {
		return (pStatement_Local_Variable_Declaration != null) ? pStatement_Local_Variable_Declaration : (pStatement_Local_Variable_Declaration = new Statement_Local_Variable_DeclarationElements());
	}
	...
	public Statement_FunctioncallOrAssignmentElements getStatement_FunctioncallOrAssignmentAccess() {
		return (pStatement_FunctioncallOrAssignment != null) ? pStatement_FunctioncallOrAssignment : (pStatement_FunctioncallOrAssignment = new Statement_FunctioncallOrAssignmentElements());
	}
	...
	public Expression_OrElements getExpression_OrAccess() {
		return (pExpression_Or != null) ? pExpression_Or : (pExpression_Or = new Expression_OrElements());
	}
	...
	public Expression_AndElements getExpression_AndAccess() {
		return (pExpression_And != null) ? pExpression_And : (pExpression_And = new Expression_AndElements());
	}
	...
	public Expression_CompareElements getExpression_CompareAccess() {
		return (pExpression_Compare != null) ? pExpression_Compare : (pExpression_Compare = new Expression_CompareElements());
	}
	...
	public Expression_ConcatenationElements getExpression_ConcatenationAccess() {
		return (pExpression_Concatenation != null) ? pExpression_Concatenation : (pExpression_Concatenation = new Expression_ConcatenationElements());
	}
	...
	public Expression_PlusMinusElements getExpression_PlusMinusAccess() {
		return (pExpression_PlusMinus != null) ? pExpression_PlusMinus : (pExpression_PlusMinus = new Expression_PlusMinusElements());
	}
	...
	public Expression_MultiplicationDivisionModuloElements getExpression_MultiplicationDivisionModuloAccess() {
		return (pExpression_MultiplicationDivisionModulo != null) ? pExpression_MultiplicationDivisionModulo : (pExpression_MultiplicationDivisionModulo = new Expression_MultiplicationDivisionModuloElements());
	}
	...
	public Expression_UnaryElements getExpression_UnaryAccess() {
		return (pExpression_Unary != null) ? pExpression_Unary : (pExpression_Unary = new Expression_UnaryElements());
	}
	...
	public Expression_ExponentiationElements getExpression_ExponentiationAccess() {
		return (pExpression_Exponentiation != null) ? pExpression_Exponentiation : (pExpression_Exponentiation = new Expression_ExponentiationElements());
	}
	...
	public Expression_NilElements getExpression_NilAccess() {
		return (pExpression_Nil != null) ? pExpression_Nil : (pExpression_Nil = new Expression_NilElements());
	}
	...
	public Expression_TrueElements getExpression_TrueAccess() {
		return (pExpression_True != null) ? pExpression_True : (pExpression_True = new Expression_TrueElements());
	}
	...
	public Expression_FalseElements getExpression_FalseAccess() {
		return (pExpression_False != null) ? pExpression_False : (pExpression_False = new Expression_FalseElements());
	}
	...
	public Expression_NumberElements getExpression_NumberAccess() {
		return (pExpression_Number != null) ? pExpression_Number : (pExpression_Number = new Expression_NumberElements());
	}
	...
	public Expression_VarArgsElements getExpression_VarArgsAccess() {
		return (pExpression_VarArgs != null) ? pExpression_VarArgs : (pExpression_VarArgs = new Expression_VarArgsElements());
	}
	...
	public Expression_FunctionElements getExpression_FunctionAccess() {
		return (pExpression_Function != null) ? pExpression_Function : (pExpression_Function = new Expression_FunctionElements());
	}
	...
	public Expression_TableConstructorElements getExpression_TableConstructorAccess() {
		return (pExpression_TableConstructor != null) ? pExpression_TableConstructor : (pExpression_TableConstructor = new Expression_TableConstructorElements());
	}
	...
	public Expression_FunctioncallElements getExpression_FunctioncallAccess() {
		return (pExpression_Functioncall != null) ? pExpression_Functioncall : (pExpression_Functioncall = new Expression_FunctioncallElements());
	}
	...
	public Expression_AccessMemberOrArrayElementElements getExpression_AccessMemberOrArrayElementAccess() {
		return (pExpression_AccessMemberOrArrayElement != null) ? pExpression_AccessMemberOrArrayElement : (pExpression_AccessMemberOrArrayElement = new Expression_AccessMemberOrArrayElementElements());
	}
	...
	public Functioncall_ArgumentsElements getFunctioncall_ArgumentsAccess() {
		return (pFunctioncall_Arguments != null) ? pFunctioncall_Arguments : (pFunctioncall_Arguments = new Functioncall_ArgumentsElements());
	}
	...
	public Field_AddEntryToTable_BracketsElements getField_AddEntryToTable_BracketsAccess() {
		return (pField_AddEntryToTable_Brackets != null) ? pField_AddEntryToTable_Brackets : (pField_AddEntryToTable_Brackets = new Field_AddEntryToTable_BracketsElements());
	}
	...
	public Field_AddEntryToTableElements getField_AddEntryToTableAccess() {
		return (pField_AddEntryToTable != null) ? pField_AddEntryToTable : (pField_AddEntryToTable = new Field_AddEntryToTableElements());
	}
	...
	public Field_AppendEntryToTableElements getField_AppendEntryToTableAccess() {
		return (pField_AppendEntryToTable != null) ? pField_AppendEntryToTable : (pField_AppendEntryToTable = new Field_AppendEntryToTableElements());
	}
	...
	public TerminalRule getLUA_NAMERule() {
		return (tLUA_NAME != null) ? tLUA_NAME : (tLUA_NAME = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "LUA_NAME"));
	} 
	...
	public TerminalRule getLUA_STRINGRule() {
		return (tLUA_STRING != null) ? tLUA_STRING : (tLUA_STRING = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "LUA_STRING"));
	} 

	//terminal LUA_NUMBER returns ecore::EDouble:
	//	"0".."9"+ ("." "0".."9"+ (("E" | "e") "-"? "0".."9"+)?)? | "0x" ("0".."9" | "a".."f")+;
	public TerminalRule getLUA_NUMBERRule() {
		return (tLUA_NUMBER != null) ? tLUA_NUMBER : (tLUA_NUMBER = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "LUA_NUMBER"));
	} 
