 ...
 * <ul>
 *   <li>{@link be.kuleuven.rodinia.dsl.lua.Statement_For_Numeric#getIteratorName <em>Iterator Name</em>}</li>
 *   <li>{@link be.kuleuven.rodinia.dsl.lua.Statement_For_Numeric#getStartExpr <em>Start Expr</em>}</li>
 *   <li>{@link be.kuleuven.rodinia.dsl.lua.Statement_For_Numeric#getUntilExpr <em>Until Expr</em>}</li>
 *   <li>{@link be.kuleuven.rodinia.dsl.lua.Statement_For_Numeric#getStepExpr <em>Step Expr</em>}</li>
 *   <li>{@link be.kuleuven.rodinia.dsl.lua.Statement_For_Numeric#getBlock <em>Block</em>}</li>
 * </ul>
 * </p>
 *
 * @see be.kuleuven.rodinia.dsl.lua.LuaPackage#getStatement_For_Numeric()
 * @model
 * @generated
 */
public interface Statement_For_Numeric extends Statement
{
   ...
   * @see be.kuleuven.rodinia.dsl.lua.LuaPackage#getStatement_For_Numeric_IteratorName()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link be.kuleuven.rodinia.dsl.lua.Statement_For_Numeric#getIteratorName <em>Iterator Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see be.kuleuven.rodinia.dsl.lua.LuaPackage#getStatement_For_Numeric_StartExpr()
  ...
  /**
   * Sets the value of the '{@link be.kuleuven.rodinia.dsl.lua.Statement_For_Numeric#getStartExpr <em>Start Expr</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see be.kuleuven.rodinia.dsl.lua.LuaPackage#getStatement_For_Numeric_UntilExpr()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link be.kuleuven.rodinia.dsl.lua.Statement_For_Numeric#getUntilExpr <em>Until Expr</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see be.kuleuven.rodinia.dsl.lua.LuaPackage#getStatement_For_Numeric_StepExpr()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link be.kuleuven.rodinia.dsl.lua.Statement_For_Numeric#getStepExpr <em>Step Expr</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setBlock(Block)
   * @see be.kuleuven.rodinia.dsl.lua.LuaPackage#getStatement_For_Numeric_Block()
   * @model containment="true"
   * @generated
   */
  Block getBlock();
  ...
  /**
   * Sets the value of the '{@link be.kuleuven.rodinia.dsl.lua.Statement_For_Numeric#getBlock <em>Block</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
