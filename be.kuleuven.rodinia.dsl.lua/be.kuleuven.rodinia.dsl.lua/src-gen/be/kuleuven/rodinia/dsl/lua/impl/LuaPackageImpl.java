...
import be.kuleuven.rodinia.dsl.lua.Chunk;
...
import be.kuleuven.rodinia.dsl.lua.LastStatement_Return;
import be.kuleuven.rodinia.dsl.lua.LastStatement_ReturnWithValue;
import be.kuleuven.rodinia.dsl.lua.LuaFactory;
...
import be.kuleuven.rodinia.dsl.lua.Statement_FunctioncallOrAssignment;
...
public class LuaPackageImpl extends EPackageImpl implements LuaPackage
{
   ...
   * @see be.kuleuven.rodinia.dsl.lua.LuaPackage#eNS_URI
   * @see #init()
   * @generated
   */
