 ...
 * <ul>
 *   <li>{@link be.kuleuven.rodinia.dsl.lua.impl.Expression_TableConstructorImpl#getFields <em>Fields</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Expression_TableConstructorImpl extends ExpressionImpl implements Expression_TableConstructor
{
  ...
  {
    return LuaPackage.Literals.EXPRESSION_TABLE_CONSTRUCTOR;
  }
  ...
  public EList<Field> getFields()
  {
    if (fields == null)
    {
      fields = new EObjectContainmentEList<Field>(Field.class, this, LuaPackage.EXPRESSION_TABLE_CONSTRUCTOR__FIELDS);
    }
    return fields;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case LuaPackage.EXPRESSION_TABLE_CONSTRUCTOR__FIELDS:
